...
# Quando passa pela função interna, o argumento >>a<< recebido pelo no parâmetro da concatenar que se tornou o valor_final é adicionado com o outro argumento passado para "valor_a_concatenar" pois na função interna tem aquele codigo dizendo que adiciona ao valor final e dps  retorna o valor final e assim finaliza a interna, e dps a função concatenar retorna o resultado da interna novamente 