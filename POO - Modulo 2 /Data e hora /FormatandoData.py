...
# Aqui acima criando a data eu não posso errar
# a ordem do formato. Abaixo, eu consigo 
# modificar como eu quero
...
# >> Ele sempre trás em string, 
# ex:print(data.strftime('%Y'))
# Como pego o número?
# add: data.year --> retorna o inteiro 
# Como fica?
# print(data.strftime('%Y'), data.year) 
# Vai dar print em str, e no inteiro